...
for file_path in path_list:
    ...
    if os.path.isdir(data_path) == 1:
        ...
        plt.gcf().canvas.draw()
        plt.imsave("time-amplitude_" + file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
        ...
        for data_ch in range(0, data.info.ch):            
            ...
            plt.xlabel('time(s)')
        plt.gcf().canvas.draw()
        plt.imsave("STFT_" +file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
        ...
        plt.gcf().canvas.draw()
        plt.imsave("WaveletDenoising_time-amplitude_" + file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
        ...
        for data_ch in range(0, data.info.ch):            
            ...
            plt.xlabel('time(s)')            
        plt.gcf().canvas.draw()
        plt.imsave("WaveletDenoising_STFT_" + file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
        ...
        for data_ch in range(0, data.info.ch):            
            ...
            plt.xlabel('time(s)') 
        plt.gcf().canvas.draw()
        plt.imsave("ExtractedNoise_STFT_" + file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
        ...
        if subpoint_intp_epocdiv_flag == True:   
            ...
            plt.gcf().canvas.draw()
            plt.imsave("subpixel_compensation-interpolation_" + file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
        ...
        plt.gcf().canvas.draw()
        plt.imsave("time-amplitude_avg_intp_" + file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')        
        ...
        plt.gcf().canvas.draw()
        plt.imsave("STFT_epoc_avg_" +file_path + "_.png", np.array(plt.gcf().canvas.renderer._renderer), format = 'png')
