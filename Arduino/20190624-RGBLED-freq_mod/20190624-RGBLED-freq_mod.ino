...
void freqRef(){
  switch(freq_n){ // 0: 40Hz, 1: 19Hz, 2: 9Hz, 3: 6Hz
    case 0: frequency = 40; period = (1000/frequency);  break;
    case 1: frequency = 19; period = (1000/frequency);  break;
    case 2: frequency = 9; period = (1000/frequency);  break;
    case 3: frequency = 6; period = (1000/frequency);  break;
    default: frequency = 40; period = (1000/frequency);  break;
  }
